...
public class tictactoe {
    ...
    public static void main(String args[])
    {
        ...
        do{
            Toe.newBoard();
            Toe.play();
            System.out.println ("Hotite igrat` snova (Enter 'yes')? ");
    ...
    public  void play()
    {
        ...
        System.out.println(  "Igrok " + getPlayer() +" hodit pervim i igraet 'X'" );

        do {
            currentBoard();
            System.out.println(  "\n\n Igrok " + getPlayer() +" vvedite nomer pozicii." );
            ...
            System.out.println(  "Horowiy hod." );
            currentBoard();
            nextPlayer();
    ...
    public  char checkWinner()
    {
        ...
        if (Winner == 'X' )
        {System.out.println("Perviy igrok pobedil!" );
            return Winner;
        }
        ...
        if (Winner == 'O' )
        {
            System.out.println( "Vtoroy igrok pobedil" );
            return Winner; }
    ...
    public  boolean checkPosn(int spot)
    {
        ...
        {
            System.out.println("Eta poziciya uje zan9ta, viberite druguyu");
            return true;
        }
        else {
            return false;
